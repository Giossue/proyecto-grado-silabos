# Especificaciones por capacidad

- `identity-academic/specification.md`: identidad, roles y estructura.
...
implementación pertenecen a `docs/architecture/` y las tareas concretas a
`docs/plans/active/`.
