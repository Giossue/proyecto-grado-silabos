...
| Gobierno y estructura académica                         | RF-008..016; CU-03; ADM-04; COR-13..15                    | `AcademicStructureTest`: jerarquía normalizada, rutas hijas, edición y eliminación auditadas, protección de historial, permisos, catálogos separados, ciclo, alcance, publicación, oferta y asignación; `CoordinatorAssignmentConstraintTest` y `ManagementCreationUiTest` | Verificado automático                                                |
| Plantillas, fuentes y logos                             | RF-017..033; CU-04..05; ADM-04..07; COR-01/11             | `TemplateAndSourceTest`, `InstitutionalLogosTest` y `DashboardMetricsTest`: proyección del encabezado, carga acotada por rol y paso de puesta en marcha                                                                                                                    | Verificado automático; autoridad/fidelidad bloqueadas PV             |
| Convocatoria, borrador y validación                     | RF-034..044; CU-06..07; COR-01..04; DOC-01..05            | `ConvocationAndDraftTest`: atomicidad, logo obligatorio, alcance, tipos, autoguardado, 409 y validación                                                                                                                                                                    | Verificado automático; volumen/UX pendientes                         |
| Envío, corrección, comparación, aprobación y reapertura | RF-045, RF-055..065; CU-09..14; DOC-07..09; COR-05..10    | `ReviewWorkflowTest`: fotografías, estados, idempotencia, concurrencia e inmutabilidad                                                                                                                                                                                     | Verificado automático; DT-07/UX pendientes                           |
...
| Redis y jobs                      | `RedisConnectionTest`, dispatch after-commit, idempotencia y smoke `critica` con worker real                            | Verificado automático/técnico                                    |
...
| PV-06                      | Cerrada      | Un sílabo por paralelo como regla; `por_paralelo` predeterminado y `por_oferta` conservado por DT-11.                            |
