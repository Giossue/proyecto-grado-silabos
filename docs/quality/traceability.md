...
| Consistencia de módulos autenticados        | RNF-001..036 como cobertura agregada de I-10 e I-17                            | —                        | CU-01..18    | UI-01..04, DOC, COR, ADM          | CP-N individuales pendientes de enunciado                  | `PageFrame`, `Table`, `TabsTrigger` activo con tokens de acción principal, `Label`/`FieldLabel`/`FieldLegend` con requerido accesible, `FormSheetActions` fijo, tokens de encabezado y filas alternas, 29 páginas operativas y layout de Configuración | `ManagementCreationUiTest`, `ResponsiveTableTest`, `TabsAppearanceTest`, `RequiredFieldsAndSheetFooterTest`, `composer verify` | Verificado automatizado / accesibilidad y dispositivos reales pendientes en PV-19                                    |
...
| Gobierno y estructura académica por carrera | RF-008..016                                                                   | RN-005..008              | CU-03        | ADM-04, COR-13..15                | CP-F estructura/alcance/configuración/inmutabilidad        | cards de malla, desglose con materias integradas, `CareerAcademicStructureController`, `MutateCurriculumBuilder`, Vue Flow, campos tipados por versión, relaciones explícitas y migraciones `000002`/`000003`/`000017` | `AcademicStructureTest`, `CoordinatorAssignmentConstraintTest`, `ActiveRoleTest`, `ManagementCreationUiTest` | Verificado automatizado / revisión manual del lienzo y PV-08 pendientes                                               |
...
| Convocatorias y generación                       | RF-034..036                                                                   | RN-017..019              | CU-06        | COR-01..04                        | CP-F convocatoria/alcance/atomicidad                            | módulo `Syllabus`, `CreateCampaign`, `OpenCampaign`                                                                      | `CampaignAndDraftTest`, `ManagementCreationUiTest`                                                            | Verificado automatizado / PV-05 y PV-08 pendientes; PV-06 cerrada                                                    |
