...
| Gobierno y estructura académica por carrera | RF-008..016                                                                   | RN-005..008              | CU-03        | ADM-04, COR-13..15                | CP-F estructura/alcance                                    | `AcademicGovernanceController`, `UpdateAcademicRecord`, `CareerAcademicStructureController`, `CatalogSection`, submenús y rutas separadas por colección, jerarquía normalizada y migraciones `000002`/`000003` | `AcademicStructureTest`, `CoordinatorAssignmentConstraintTest`, `ActiveRoleTest`, `ManagementCreationUiTest` | Verificado automatizado                                                                                               |
