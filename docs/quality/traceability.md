...
| Consistencia de módulos autenticados        | RNF-001..036 como cobertura agregada de I-10 e I-17                            | —                        | CU-01..18    | UI-01..04, DOC, COR, ADM          | CP-N individuales pendientes de enunciado                  | `PageFrame`, `Table`, `Label`/`FieldLabel`/`FieldLegend` con requerido accesible, `FormSheetActions` fijo, tokens de encabezado y filas alternas, 29 páginas operativas y layout de Configuración | `ManagementCreationUiTest`, `ResponsiveTableTest`, `RequiredFieldsAndSheetFooterTest`, `composer verify`      | Verificado automatizado / accesibilidad y dispositivos reales pendientes en PV-19                                    |
