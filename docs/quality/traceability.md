...
| Gobierno y estructura académica por carrera | RF-008..016                                                                   | RN-005..008              | CU-03        | ADM-04, COR-13..15                | CP-F estructura/alcance/configuración/inmutabilidad        | `CareerAcademicStructureController`, `MutateCurriculumBuilder`, Vue Flow, vista formulario equivalente, campos tipados por versión, relaciones explícitas y migraciones `000002`/`000003`/`000017` | `AcademicStructureTest`, `CoordinatorAssignmentConstraintTest`, `ActiveRoleTest`, `ManagementCreationUiTest` | Verificado automatizado / revisión manual del lienzo y PV-08 pendientes                                               |
