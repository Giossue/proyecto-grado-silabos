...
período solo muestra materias sin oferta para el período seleccionado y crea su primer
paralelo. Los paralelos posteriores se agregan de forma individual desde las acciones
de la oferta, con su jornada. Ninguna omisión elimina oferta, paralelo ni historia.
...
- `php artisan test --compact tests/Feature/Academic/AcademicStructureTest.php tests/Architecture/ManagementCreationUiTest.php`: 59 pruebas y 1.502 aserciones.
