    ...
    public function forAdministrator(): array
    {
        ...
        return $this->build(
            ...
            [
                ...
                $this->step('coordinators', 'Asignar un coordinador a cada carrera', $careerCount > 0 && $careersWithoutCoordinator > 0 ? "Faltan {$careersWithoutCoordinator} de {$careerCount} carreras." : 'Titular o encargado actualmente activo.', $careerCount > 0 && $careersWithoutCoordinator === 0, route('admin.academic.index', 'carreras')),
