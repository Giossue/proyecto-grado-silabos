...
const authConfigContent = computed<TwoFactorConfigContent>(() => {
    if (showRecoveryInput.value) {
        return {
            ...
            description:
                'Confirme el acceso con uno de sus códigos de recuperación.',
            buttonText: 'usar un código de autenticación',
        };
    }
    ...
    return {
        ...
        description:
            'Ingrese el código proporcionado por su aplicación de autenticación.',
