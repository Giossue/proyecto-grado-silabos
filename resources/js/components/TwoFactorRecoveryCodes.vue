...
<template>
    <Card class="w-full">
        <CardHeader>
            ...
            <CardDescription>
                Permiten recuperar el acceso si pierde el dispositivo 2FA.
                Guárdelos en un gestor de contraseñas seguro.
            </CardDescription>
        </CardHeader>
        <CardContent>
            <div
            ...
            >
                ...
                <div v-else class="mt-3 space-y-3">
                    ...
                    <p class="text-xs text-muted-foreground select-none">
                        Cada código se usa una sola vez y se elimina después. Si
                        necesita otros, pulse
