...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            ...
            description:
                'La autenticación de dos factores está activa. Escanee el código QR o ingrese la clave en su aplicación.',
            buttonText: 'Cerrar',
        };
    }
    ...
    if (showVerificationStep.value) {
        return {
            ...
            description: 'Ingrese el código de seis dígitos de su aplicación',
    ...
    return {
        ...
        description:
            'Para terminar, escanee el código QR o ingrese la clave en su aplicación',
        buttonText: 'Continuar',
    };
});
    ...
    <Dialog :open="isOpen" @update:open="isOpen = $event">
        <DialogContent class="sm:max-w-md">
            <DialogHeader class="flex items-center justify-center">
                <div
                    class="mb-3 w-auto rounded-full border border-border bg-card p-0.5 shadow-surface"
                >
                    <div
                    ...
                    <template v-else>
                        ...
                        >
                            ...
                            <span class="relative bg-card px-2 py-1"
                                >o ingrese la clave manualmente</span
                            >
                        </div>
